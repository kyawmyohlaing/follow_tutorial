...
const NETWORK_PASSPHRASE = "Stanford Net; March 2020"
...
const getFromFaucet = async (req,res) =>{
    try{
        ...
        if(pk){
            ...
            let sourceKeys = Stellar.Keypair.fromSecret("SBZOO36G2FS7HFU7KYYXXGCQIJBW77IW7YHGQ4WP4L6PKRGPEYVTN56D");
            // loading root account
            server.loadAccount(sourceKeys.publicKey())
            .then(function(sourceAccount) {
                let txn = new Stellar.TransactionBuilder(sourceAccount, {fee: 10})
                            .addOperation(
                            ...
                            .setTimeout(180)
                            .setNetworkPassphrase('Stanford Net; March 2020')
                            .build();
                txn.sign(sourceKeys);
